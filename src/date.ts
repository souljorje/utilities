 ...
 */
export function dateToString(date: DateInput, options?: DateToStringOptions | boolean): string {
 ...
 */
export function dateDiffStructure(date: DateInput, units?: TimeUnitName[]): TimeStructure {
 ...
 */
function dateDiffStructureToString(date: DateInput, diffStructure: TimeStructure, {
  unitsCount,
  short,
  prefix,
}: Pick<DateDiffOptions, 'unitsCount' | 'short' | 'prefix'>): string {
 ...
 */
export function dateStructureToTime(structure: TimeStructure): number {
 ...
 */
export function getDateDiff(date: DateInput, opts: DateDiffOptions = {}): string {
  if (opts.limit) {
 ...
 */
export function toLocalUtcDate(date: Date): Date {
  return new Date(
    date.getUTCFullYear(),
    date.getUTCMonth(),
    date.getUTCDate(),
